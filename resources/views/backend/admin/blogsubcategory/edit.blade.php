...
@section('content')
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            <div class="row">
                <div class="col-12">
                    <form method="POST" action="{{ url('admin/sub/category/blog/'.$sub_category->id) }}" class="">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-12">
                                ...
                                <div class="form-row mb-3">
                                    <div class="col-md-4">
                                        ...
                                        <input id="title" type="text" class="form-control @error('title') is-invalid @enderror" name="title" value="{{ $sub_category->title }}">
                                        @error('title')
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input id="slug" type="text" class="form-control @error('slug') is-invalid @enderror" name="slug" value="{{ $sub_category->slug }}">
                                    ...
                                    <div class="col-md-4">
                                        <label for="slug" class="text-black">Parent Category</label>
                                        <select name="category_id" class="form-control">
                                            @foreach ($categories as $category)
                                                <option value="{{ $category->id }}" @if($sub_category->blog_category_id == $category->id) selected @endif>{{ $category->title }}</option>
                                            @endforeach
                                        </select>
                                        @error('category_id')
                                        <span class="invalid-tooltip">
