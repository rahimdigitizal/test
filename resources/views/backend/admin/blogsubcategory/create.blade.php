...
@section('content')
    ...
    <div class="row justify-content-between">
        <div class="col-9">
            <h1 class="h3 mb-2 text-gray-800">Add A Sub Category</h1>
            <p class="mb-4">This page allows you to create a new sub category record in the database.</p>
        </div>
    ...
    <div class="row bg-white pt-4 pl-3 pr-3 pb-4">
        <div class="col-12">
            <div class="row">
                <div class="col-12">
                    <form method="POST" action="{{ url('admin/sub/category/blog') }}" class="">
                        @csrf
                        ...
                        <div class="row border-left-primary mb-4">
                            <div class="col-12">
                                ...
                                <div class="form-row mb-3">
                                    <div class="col-md-4">
                                        <label for="title" class="text-black">Sub category name</label>
