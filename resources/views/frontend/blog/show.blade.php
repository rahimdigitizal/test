                ...
                <div class="col-md-10" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="row justify-content-center mt-5">
                        <div class="col-md-8 text-center">
                            ...
                            @if($data['category'])
                                <p>{{ $data['category']->title }} <i class="fa fa-angle-right" style="font-size: 10px;"></i> {{ $data['sub_category']->title }}</p>
                            @else
        ...
        <div class="container">
                ...
                <div class="col-md-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            @if($data['category'])
                                <li class="breadcrumb-item">{{ $data['category']->title }} / {{ $data['sub_category']->title }}</li>
                            @endif
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    @else
                        <div class="mb-3" style="min-height:627px;border-radius: 0.25rem;background-image:url('{{ asset('blogs'.'/' . $data['post']->image) }}');background-size:cover;background-repeat:no-repeat;background-position: center center;"></div>
                    @endif
                        ...
                        <div class="mb-5">
                            ...
                            @if($data['category'])
                                {{ $data['category']->title }} <i class="fa fa-angle-right" style="font-size: 10px;"></i> {{ $data['sub_category']->title }}
                            @else
                                {{ __('frontend.blog.uncategorized') }}
                            @endif
